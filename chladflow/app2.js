...
APP.mouse = {
  ...
  getMousePos( canvas, e ) {
    ...
    return [Math.max(Math.min(e.clientX - rect.left, rect.right - rect.left), 0),
            Math.max(Math.min(e.clientY - rect.top,  rect.bottom - rect.top), 0)];
  },
  
  handleDown : function( e ) {
    APP.mouse.fixWhich( e );
    APP.mouse.buttonDown[ e.which-1 ] = true;
    APP.mouse.lastPos = APP.mouse.getMousePos(APP.core.canvas,e);
  },
  ...
  handleMove : function( e ) {
    var curPos = APP.mouse.getMousePos(APP.core.canvas,e);
    APP.mouse.delta[0] = curPos[0] - APP.mouse.lastPos[0];
    APP.mouse.delta[1] = curPos[1] - APP.mouse.lastPos[1];
    APP.mouse.lastPos = curPos;
  }
};
...
APP.core = {
  ...
  handleMouseDown : function( e ) { APP.mouse.handleDown(e); },	
  handleMouseUp   : function( e ) { APP.mouse.handleUp(e); },	
  handleMouseMove : function( e ) { APP.mouse.handleMove(e); }
  ///@}
};
